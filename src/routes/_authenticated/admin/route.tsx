...
const NAV = [
  { to: "/admin", label: "المحتوى", icon: BookOpen },
  ...
  if (!isAdmin) {
    return (
      <main className="mx-auto max-w-lg px-4 py-24 text-center">
        <h1 className="text-2xl font-black">صلاحيات غير كافية</h1>
        <p className="mt-2 text-muted-foreground">هذه الصفحة مخصصة للمدرّس / الإدارة فقط.</p>
        <Button className="mt-6" asChild>
          <Link to="/dashboard">العودة للوحة الطالب</Link>
        </Button>
      </main>
    );
  }
