...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "منصة خليك علومنجي | أ. أحمد حجازي - دروس وامتحانات أونلاين" },
      {
        name: "description",
        content:
          "منصة خليك علومنجي - منصة الأستاذ أحمد حجازي التعليمية (منصة حجازي): شرح فيديو منظم في وحدات، امتحانات إلكترونية بمؤقت وتصحيح فوري، وتفعيل الكورسات بالأكواد.",
      },
      {
        name: "keywords",
        content: "منصة استاذ احمد حجازي, احمد حجازي, منصة حجازي, منصة خليك علومنجي, منصة احمد حجازي",
      },
      { property: "og:title", content: "منصة خليك علومنجي | أ. أحمد حجازي" },
      {
        property: "og:description",
        content: "منصة أحمد حجازي - دروس فيديو محمية، امتحانات بمؤقت وتصحيح فوري، ومتابعة كاملة لمستوى الطالب.",
      },
    ],
  }),
  component: Landing,
